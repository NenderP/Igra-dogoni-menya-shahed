...
public static class CharacterCatalog
{
    ...
    {
        ["char_eclipse_sovereign"] = new("char_eclipse_sovereign", 5, TimeOfDay.Eclipse, 30, 3),
        ["char_dawn_herald"]       = new("char_dawn_herald",       5, TimeOfDay.Dawn,    28, 3),
        ["char_day_mage"]          = new("char_day_mage",          4, TimeOfDay.Day,     24, 2),
        ["char_night_assassin"]    = new("char_night_assassin",    4, TimeOfDay.Night,   24, 2),
        ["char_twilight_trickster"]= new("char_twilight_trickster",4, TimeOfDay.Twilight, 22, 2),
        ["char_dusk_scout"]        = new("char_dusk_scout",        4, TimeOfDay.Twilight, 22, 2),
        ["char_day_squire"]        = new("char_day_squire",        3, TimeOfDay.Day,     18, 2),
        ["char_night_initiate"]    = new("char_night_initiate",    3, TimeOfDay.Night,   18, 2),
    };

    /// <summary>Базовая атака по редкости — БАЛАНС-TBD.</summary>
    public static int DefaultAttack(int rarity) => rarity >= 5 ? 7 : rarity == 4 ? 6 : 5;
